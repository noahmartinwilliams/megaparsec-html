...
data Tag = NullTag | CSSNode String (Map String String) CSSDoc | JSNode String (Map String String) (Maybe JS.Doc) | Node String (Map String String) | TextNode String deriving(Show, Eq)
